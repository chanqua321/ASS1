...
namespace Model.Migrations
{
    ...
    [Migration("20260604170214_AddDocumentUploadedByUserId")]
    partial class AddDocumentUploadedByUserId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Model.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "100000.RWR1QUlfVXNlclNlZWQhIQ==.Bexafofd0/xrgmR+AgoioivdJ1P/cIauSK07DRkGD3U=",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Model.Entities.Document", b =>
                {
                    ...
                    b.HasOne("Model.Entities.AppUser", "UploadedByUser")
                        .WithMany()
